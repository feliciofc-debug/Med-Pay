...
// Contexto de cliente
// ============================================================
// "Entrar no hospital" (header X-Cliente) está desligado: cada login opera
// só o próprio tenant. Limpa qualquer contexto antigo que tenha ficado no
// navegador pra não mandar X-Cliente por engano.
